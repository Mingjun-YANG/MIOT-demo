package com.xiaomi.iot.example.operater.impl;
...
import com.xiaomi.iot.example.operater.RequestOperater;
import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;
import com.xiaomi.iot.example.typedef.*;
import com.xiaomi.iot.example.validator.impl.LocalDBValidatorImpl;
...
public class RequestOperaterImpl implements RequestOperater {
    ...
    public JSONArray getProperties(String uid, List<PropertyRequest> list) throws Exception{
        ...
        for (com.xiaomi.iot.example.typedef.PropertyRequest PropertyRequest : list) {
            ...
            List<Services> services = deviceDB.getServices(instance);
            for (com.xiaomi.iot.example.typedef.Services Services : services) {
