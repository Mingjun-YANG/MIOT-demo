...
//     */
//    @Override
//    public void get(PropertyOperation property, JSONArray did) throws JSONException {
//
//        DatabaseOperater databaseOperater = new DatabaseOperater();
//
//        for (int i = 0 ; i < property.did.length(); i++) {
//            for (int j = 0; j < did.length(); j++) {
//                databaseOperater.databaseReader(did.get(j).);
//
//            }
//        }
//        // 如果成功， status = 0， 且返回属性值
//        if (property.did.equals(did.getString("did"))) {
//            property.status = 0;
//            property.value = 13;
//        } else
//            // 如果失败， status为负值，且携带description（见文档《第三方设备云接入小米IOT平台》）
